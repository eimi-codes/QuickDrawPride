...
GraphicsCommand gay_brazil_flag_commands[]={
	...
	// Globe
	GraphicsCommand(Ellipse,PridePoint(v_2_1,h_2_1),137,137,RGB( 40, 22,111)),
	// Banner
	GraphicsCommand(ShapePolygon,polygon_brazil0,RGB(255,255,255)),
	// Letters oh god
	...
	// So many stars!
	GraphicsCommand(Star,PridePoint(373,179),BigStar,RGB(255,255,255)),
	GraphicsCommand(Star,PridePoint(410,286),BigStar,RGB(255,255,255)),
	GraphicsCommand(Star,PridePoint(201,241),BigStar,RGB(255,255,255)),
	GraphicsCommand(Star,PridePoint(295,304),TinyStar,RGB(255,255,255)),
	GraphicsCommand(Star,PridePoint(288,314),TinyStar,RGB(255,255,255)),
	GraphicsCommand(Star,PridePoint(295,363),TinyStar,RGB(255,255,255)),

	GraphicsCommand(Star,PridePoint(253,254),MediumStar,RGB(255,255,255)),
	GraphicsCommand(Star,PridePoint(231,265),MediumStar,RGB(255,255,255)),
	GraphicsCommand(Star,PridePoint(220,281),MediumStar,RGB(255,255,255)),
	GraphicsCommand(Star,PridePoint(220,307),MediumStar,RGB(255,255,255)),
	GraphicsCommand(Star,PridePoint(248,304),MediumStar,RGB(255,255,255)),
	GraphicsCommand(Star,PridePoint(245,324),MediumStar,RGB(255,255,255)),
	GraphicsCommand(Star,PridePoint(268,331),MediumStar,RGB(255,255,255)),
	GraphicsCommand(Star,PridePoint(277,311),MediumStar,RGB(255,255,255)),
	GraphicsCommand(Star,PridePoint(291,286),MediumStar,RGB(255,255,255)),
	GraphicsCommand(Star,PridePoint(311,307),MediumStar,RGB(255,255,255)),
	GraphicsCommand(Star,PridePoint(299,325),MediumStar,RGB(255,255,255)),
	GraphicsCommand(Star,PridePoint(342,236),MediumStar,RGB(255,255,255)),
	GraphicsCommand(Star,PridePoint(342,236),MediumStar,RGB(255,255,255)),
	GraphicsCommand(Star,PridePoint(344,322),MediumStar,RGB(255,255,255)),
	GraphicsCommand(Star,PridePoint(358,347),MediumStar,RGB(255,255,255)),
	GraphicsCommand(Star,PridePoint(366,322),MediumStar,RGB(255,255,255)),
	GraphicsCommand(Star,PridePoint(384,321),MediumStar,RGB(255,255,255)),
	GraphicsCommand(Star,PridePoint(380,342),MediumStar,RGB(255,255,255)),
	GraphicsCommand(Star,PridePoint(379,359),MediumStar,RGB(255,255,255)),
	GraphicsCommand(Star,PridePoint(404,309),MediumStar,RGB(255,255,255)),
	GraphicsCommand(Star,PridePoint(419,306),MediumStar,RGB(255,255,255)),
	GraphicsCommand(Star,PridePoint(411,321),MediumStar,RGB(255,255,255)),
	GraphicsCommand(Star,PridePoint(426,289),MediumStar,RGB(255,255,255)),
